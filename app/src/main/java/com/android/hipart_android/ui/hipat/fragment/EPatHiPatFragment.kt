...
//    }
    ...
    fun setAdapterData(adapterDataList: List<GetMyPickData>) {
        if(adapterDataList.isEmpty()){
            frag_hipat_e_no_result.visibility = View.VISIBLE
            rv_hipat_epat_frag.visibility = View.GONE

        }else{
            frag_hipat_e_no_result.visibility = View.GONE
            rv_hipat_epat_frag.visibility = View.VISIBLE
