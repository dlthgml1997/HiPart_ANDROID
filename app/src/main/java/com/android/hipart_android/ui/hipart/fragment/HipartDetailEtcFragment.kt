...
class HipartDetailEtcFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        user = arguments!!.getSerializable("user") as UserDetailEEtcData
    ...
    private fun setView() {
        ...
        if(user.etc != 0) {
            tv_frag_hip_det_eetc_pd.text = Filter.etc(user.etc)
        }else
    ...
    private fun setArticleList(user: UserDetailEEtcData) {
    ...
    private fun setTagList(user: UserDetailEEtcData) {
