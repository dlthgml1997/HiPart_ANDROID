...
import com.android.hipart_android.ui.hipat.adapter.HipatAdRecyclerViewAdapter
import com.android.hipart_android.ui.hipat.adapter.HipatMainPagerAdapter
...
class HiPatFragment : Fragment() {
    ...
    lateinit var hipatAdRecyclerViewAdapter : HipatAdRecyclerViewAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        configureAdRecyclerView()
        configureMainTab()
        //setOnTabSelectedListener()
    }

    private fun configureAdRecyclerView() {
        val dataList: ArrayList<AdData> = ArrayList()

        hipatAdRecyclerViewAdapter = HipatAdRecyclerViewAdapter(context!!,dataList)
        rv_hipat_frag_advertisement.adapter= hipatAdRecyclerViewAdapter
        rv_hipat_frag_advertisement.layoutManager = LinearLayoutManager(context!!,LinearLayoutManager.HORIZONTAL,false)
    }

    private fun configureMainTab(){
        vp_hipat_frag_nav.adapter = HipatMainPagerAdapter(fragmentManager!!,5)
