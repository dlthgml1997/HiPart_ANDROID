...
data class GetDetailCResponse(
    val status: Int,
    val success: Boolean,
    val message: String,
    val data: DetailCData
)

data class DetailCData(
    val hifiveState: Int,
    val resData: UserDetailCData
)
 ...
 */
data class UserDetailCData(
    var user_nickname: String,
    val user_img: String?,
    var user_type: Int,
    val detail_platform: Int,
    val detail_subscriber: String,
